...
class Login2 extends React.Component {
	...
	showErrors(fieldName) {
		...
		if (validator && !validator.valid) {
			const errors = validator.errors.map((info, index) => <span className="error" key={index}>* {info}<br /></span>);
				...
				<div >
					<Row className="no-gutters justify-content-center">
						<Col md="6" lg="4" className="bg-dark text-white">
							<div className="p-4">
								<h2 className="text-white display-5">Hi,<br /> <span className="text-info font-bold">Dude</span></h2>
